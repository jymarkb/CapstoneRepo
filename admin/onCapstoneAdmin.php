...
<head>
	...
	<script>
      $(document).ready(function(){
        ...
        var checkCat1=0; var checkCat2=0; var checkCat3=0; var checkCat4=0; var checkCat5 = 0;
        var item = $("#searchBox").val();
        function getDataFilter(){
          var item = $("#searchBox").val();
            $("#tableCapstoneData").load("../php/capstoneAdmin/searchCapstoneFilter.php",{
                NewItem:item,cat1:checkCat1,cat2:checkCat2,cat3:checkCat3,cat4:checkCat4,cat5:checkCat5
            });
          ...
          $("#addContent").click(function(){
            ...
            data:{author:author,category:category,abstract:abstract,keyword:keyword,title:title},
          ...
          $(document).on('click', '#updateContent', function (){
            ...
            data:{author:author,category:category,abstract:abstract,keyword:keyword,title:title,capid:capid},
            success:function(response) {
              if (response=="success") {
                clearData();
